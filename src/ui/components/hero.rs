    ...
    view! {
        <section class="hero" id="top">
            ...
            <div class="hero-inner container">
                ...
                <h1 class="hero-title">
                    "I build the data and model " <span class="lit">"infrastructure"</span>
                    " behind " <span class="soft">"intelligent products."</span>
                </h1>
                <p class="hero-lede">
                ...
                <p class="hero-meta">"data & ai engineer · la plata, ar · rust / python / zig"</p>
            </div>
